...
export const getArticle = async (id) => {
  const data = await db.Article.findOne({ where: { id }});
 ...
 */
export const saveArticle = async (email, boardId, title, content) => {
